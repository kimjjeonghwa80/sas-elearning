        ...
        <div class="preloader3 display-none"></div>
          ...
          <div class="card-header">
              <h3 class="m-3 text-center text-dark ">
                  Installing Dynamo eClass - Learning Management System
              </h3>
          </div>
